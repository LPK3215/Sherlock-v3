...
感谢你对 Sherlock-v3 的兴趣。我们欢迎 Issue、文档改进、Bug 修复、测试补充以及新功能贡献。
...
- 搜索已有 [Issues](https://github.com/LPK3215/Sherlock-v3/issues)
...
Sherlock-v3 基于 Docker Compose 管理开发环境。开发、调试、测试都应尽量在运行中的容器中完成。
...
- Bug 反馈：<https://github.com/LPK3215/Sherlock-v3/issues>
- 功能讨论：<https://github.com/LPK3215/Sherlock-v3/discussions>
